...
TEST(MapTest, Map2DimentionTest) {
    ...
    ASSERT_EQ(map2->getHeight(),15) << "Map 1 reading problem: height not calculated correctly.";
    ASSERT_EQ(map2->getWidth(),20) << "Map 1 reading problem: width not calculated correctly.";
    delete map2;
}
